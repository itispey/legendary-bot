...
local function log_error(method, code, extras, description)
	...
	local ignored_errors = {110, 111, 114, 116, 118, 131, 150, 155, 403, 429}
...
function api.setChatPermissions(chat_id, permissions)

	local url = BASE_URL .. '/setChatPermissions?chat_id=' .. chat_id
...
function api.sendPoll(chat_id, question, options, reply_markup, reply_to_message_id, disable_notification)

	local url = BASE_URL .. '/sendPoll?chat_id=' .. chat_id .. '&question=' .. URL.escape(question) .. '&options=' .. URL.escape(JSON.encode(options))
...
function api.stopPoll(chat_id, message_id, reply_markup)

	local url = BASE_URL .. '/stopPoll?chat_id=' .. chat_id .. '&message_id=' .. message_id
...
function api.sendDocumentId(chat_id, file_id, reply_to_message_id, caption, reply_markup, parse_mode)
